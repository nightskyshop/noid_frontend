...
import styles from "../styles/ddp_dwyl.module.css";

export default function DdpDwyl() {
  const goSelectFrame = () => {
    window.location.href = "/take_photo-1?frame=sjj_2";
  };
    ...
    <>
      ...
      <div className={styles.dwyl}>
        ...
        <div className={styles.div6}>
          <div className={styles["do-what-you-like"]}>DO WHAT YOU LIKE</div>
        </div>
      </div>
    </>
  );
