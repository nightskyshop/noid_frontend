...
import styles from "../styles/noid_dankook_b.module.css";
import Snowfall from "react-snowfall";

export default function NoidDankookB() {
  const goSelectFrame = () => {
    window.location.href = "/take_photo-1?frame=dankook_b";
  };
  ...
  return (
    <>
      <Head>
        <title>NOID BLACK 프레임</title>
        <meta charSet="UTF-8" />
        <meta httpEquiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      </Head>
      <div className={styles["dankook-b"]}>
        ...
        <div className={styles.div6}>
          <div className={styles["noid-black"]}>NOID BLACK</div>
        </div>
      </div>
    </>
  );
